...
(1,  1, 14, 'Gather requirements',        '[]', '2025-01-05 09:30:00', '2025-01-06 10:00:00', '2025-01-06 09:00:00', '2025-01-06 10:00:00', 'Alice',   'High',   'Reminder'),
(2,  1, 12, 'Create wireframes',          '[]', '2025-01-06 10:30:00', NULL,                  '2025-01-08 12:00:00', '2025-01-08 14:00:00', 'Bob',     'Medium', 'Dev'),
-- Website Redesign / Implementation
(3,  2, 11, 'Build landing page',         '[]', '2025-01-07 09:00:00', NULL,                  '2025-01-12 17:00:00', '2025-01-12 18:00:00', 'Charlie', 'High',   'Dev'),
(4,  2, 9,  'CSS styling pass',           '[]', '2025-01-08 13:00:00', NULL,                  NULL,                  NULL,                  'Alice',   'Low',    'Dev'),
-- Mobile App / MVP Tasks (project 2, workflow 3)
(5,  3, 12, 'Implement login flow',       '[]', '2025-01-10 11:30:00', NULL,                  '2025-01-18 18:00:00', '2025-01-18 19:00:00', 'Diana',   'Urgent', 'Dev'),
(6,  3, 10, 'Local storage setup',        '[]', '2025-01-11 09:45:00', NULL,                  NULL,                  NULL,                  'Evan',    'Medium', 'Dev'),
-- Mobile App / QA & Release
(7,  4, 11, 'Write test cases',           '[]', '2025-01-15 17:00:00', NULL,                  '2025-01-20 10:00:00', '2025-01-20 12:00:00', 'Frank',   'High',   'Test'),
(8,  4, 9,  'App Store submission',       '[]', '2025-01-18 14:00:00', NULL,                  NULL,                  NULL,                  'Diana',   'Urgent', 'Reminder'),
-- Chores / Household (project 3, workflow 1)
(9,  5, 3,  'Take out the trash',         '[]', '2026-05-12 08:00:00', '2026-05-13 07:30:00', NULL,                  NULL,                  '', 'Low',    'Reminder'),
(10, 5, 2,  'Laundry',                    '[]', '2026-05-14 09:00:00', NULL,                  '2026-05-14 18:00:00', '2026-05-14 20:00:00', '', 'Medium', 'Reminder'),
(11, 5, 1,  'Clean the kitchen',          '[]', '2026-05-14 10:00:00', NULL,                  '2026-05-17 10:00:00', '2026-05-17 12:00:00', '', 'Medium', 'Reminder'),
(12, 5, 3,  'Mow the lawn',               '[]', '2026-05-08 09:00:00', '2026-05-10 13:00:00', '2026-05-10 11:00:00', '2026-05-10 13:00:00', '', 'Low',    'Reminder'),
-- Chores / Errands
(13, 6, 1,  'Grocery shopping',           '[]', '2026-05-14 08:30:00', NULL,                  '2026-05-15 17:00:00', '2026-05-15 18:30:00', '', 'Medium', 'Reminder'),
(14, 6, 3,  'Pay credit card bill',       '[]', '2026-05-10 09:00:00', '2026-05-11 14:00:00', NULL,                  NULL,                  '', 'High',   'Reminder'),
-- Job Hunt / Tech Giants (project 4, workflow 2)
(15, 7, 4,  'Google - Senior SWE',        '[]', '2025-03-05 11:00:00', NULL,                  NULL,                  NULL,                  '', 'High',   'Reminder'),
(16, 7, 5,  'Meta - Software Engineer',   '[]', '2025-03-06 09:30:00', NULL,                  '2025-03-09 10:00:00', '2025-03-09 11:00:00', '', 'High',   'Reminder'),
(17, 7, 6,  'Apple - Frontend Engineer',  '[]', '2025-03-08 14:00:00', NULL,                  '2025-03-15 13:00:00', '2025-03-15 14:00:00', '', 'Urgent', 'Reminder'),
(18, 7, 5,  'Stripe - Backend Engineer',  '[]', '2025-03-14 16:00:00', NULL,                  '2025-03-16 09:00:00', '2025-03-16 10:00:00', '', 'Medium', 'Reminder'),
-- Job Hunt / Startups
(19, 8, 7,  'Vercel - DevOps',            '[]', '2025-03-10 11:15:00', '2025-03-20 17:00:00', '2025-03-18 16:00:00', '2025-03-18 17:00:00', '', 'Urgent', 'Reminder'),
(20, 8, 8,  'Linear - Software Engineer', '[]', '2025-03-12 09:00:00', '2025-03-22 12:00:00', NULL,                  NULL,                  '', 'Medium', 'Reminder'),
(21, 8, 6,  'Supabase - Backend',         '[]', '2025-03-15 10:00:00', NULL,                  '2025-03-25 14:00:00', '2025-03-25 15:00:00', '', 'High',   'Reminder');
